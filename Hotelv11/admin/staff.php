...
<head>
    ...
    <style>
        .roombox{
            background-color:rgba(81, 202, 48, 0.897);
            padding: 10px;
        }
    </style>
</head>
...
<div class="addstaffsection">
    <form id="addStaffForm" action="" method="POST" onsubmit="return validateForm()">
        ...
        <select name="staffwork" class="form-control">
            ...
            <option value="System Administrators">System Administrator</option>
        </select>
...
<script>
    function validateForm() {
        var staffName = document.forms["addStaffForm"]["staffname"].value;
        var staffWork = document.forms["addStaffForm"]["staffwork"].value;
